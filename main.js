...
const cardPhrase = document.querySelector('.card-phrase');
const cookieClosed = document.querySelector('#cookie');
const btnTry = document.querySelector('#btnTry');

let randomPhrase = document.querySelector("#randomPhrase");
let phraseGenerator = Math.floor(Math.random() * (phrases.length));

cookieClosed.addEventListener('click', getRandomPhrase)
...
function toggleCookie() {
  ...
  cardPhrase.classList.toggle("hide")
}
